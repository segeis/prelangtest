...
class StationsControllerTest < ActionController::TestCase
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post :create, station: { company_id: @station.company_id, description: @station.description, name: @station.name, user_id: @station.user_id }
    end
  ...
  test "should update station" do
    patch :update, id: @station, station: { company_id: @station.company_id, description: @station.description, name: @station.name, user_id: @station.user_id }
    assert_redirected_to station_path(assigns(:station))
  end
