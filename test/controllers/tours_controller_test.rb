...
class ToursControllerTest < ActionController::TestCase
  ...
  test "should create tour" do
    assert_difference('Tour.count') do
      post :create, tour: { description: @tour.description, name: @tour.name, station_id: @tour.station_id, user_id: @tour.user_id }
    end
  ...
  test "should update tour" do
    patch :update, id: @tour, tour: { description: @tour.description, name: @tour.name, station_id: @tour.station_id, user_id: @tour.user_id }
    assert_redirected_to tour_path(assigns(:tour))
  end
